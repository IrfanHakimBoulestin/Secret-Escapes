...
<div class="make-a-transfer-container">
    <g:form action="processTransfer" id="process-transfer-request">
        <div class="form-group">
            <g:select from="${account}" name="accountFrom" value="${account.getAccountName()}" optionValue="accountName"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <g:select from="${toAccounts}" name="accountTo" optionValue="accountName"/>
        </div>
